...
#define PIEZO_PIN_0_PS		(PIEZO_PIN__0__PS)
#define PIEZO_PIN_0_PC		(PIEZO_PIN__0__PC)
#define PIEZO_PIN_0_DR		(PIEZO_PIN__0__DR)
#define PIEZO_PIN_0_SHIFT	(PIEZO_PIN__0__SHIFT)
