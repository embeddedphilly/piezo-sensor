...
module CapSense_CSD_P4_v2_20_4 ;
	...
	cy_clock_v1_0
		#(.id("ea98003e-a404-4309-9176-1423b4761339/74063576-f256-4f8f-8a82-9abdee876261"),
	...
	cy_psoc3_pins_v1_10
		#(.id("ea98003e-a404-4309-9176-1423b4761339/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ea98003e-a404-4309-9176-1423b4761339/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
	...
	cy_clock_v1_0
		#(.id("ea98003e-a404-4309-9176-1423b4761339/9a635726-510c-483c-9c5c-3e233ee2906a"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__TRIGGER_TIMER_net;
	wire [0:0] tmpIO_0__TRIGGER_TIMER_net;
	wire [0:0] tmpINTERRUPT_0__TRIGGER_TIMER_net;
	electrical [0:0] tmpSIOVREF__TRIGGER_TIMER_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		TRIGGER_TIMER
		 (.oe(tmpOE__TRIGGER_TIMER_net),
		  .y({1'b0}),
		  .fb({Net_94}),
		  .io({tmpIO_0__TRIGGER_TIMER_net[0:0]}),
		  .siovref(tmpSIOVREF__TRIGGER_TIMER_net),
		  .interrupt({tmpINTERRUPT_0__TRIGGER_TIMER_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TRIGGER_TIMER_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CapSense_CSD_P4_v2_20_4 CapSense ();
